...
// why using switch instead of if else? code optimization; solve readable when code gets complicated;
// it is recommeneded to use most highly expected conditions from the top and then go down
// switch in java can only take integer / characters as input
// java8??
