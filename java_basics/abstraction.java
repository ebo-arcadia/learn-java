...
// abstract method does not implementation but only signiture
// method must be declared abstract in class to be abstract method
// any class extends a class with abstract method, that class must implement all abstract methods in it