...
// string is a final class immutable and can not be changed once created
// string constant pool in java virtual mechine allows string be initialized without the 'new' keyword
// no need to import string class. java automatically provides it
// reference can be overriden but the content does not get deleted
// multiple references can be used for the same string
// numbers wrapped in "" becomes a string
