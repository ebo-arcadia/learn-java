...
class math_ceil_floor {
    public static void main(String[] args) {
        double num1 = 98.8;
        double num2 = 0.33;
        System.out.println("Round off for num1: " + Math.ceil(num1));
        System.out.println("Round off for num1: " + Math.floor(num1));
        System.out.println("Round off for num1: " + Math.ceil(num2));
        System.out.println("Round off for num1: " + Math.floor(num2));
    }
}
